...
import cn.net.aipic.sysadminuser.utils.HttpStatus;
...
public class OAuth2Filter extends AuthenticatingFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if("OPTIONS".equals(httpRequest.getMethod()) || "GET".equals(httpRequest.getMethod()) || "POST".equals(httpRequest.getMethod())){
            return true;
        }
