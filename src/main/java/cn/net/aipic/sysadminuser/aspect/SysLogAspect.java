...
import cn.net.aipic.sysadminuser.utils.HttpContextUtils;
import cn.net.aipic.sysadminuser.utils.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("execution(* cn.net.aipic.sysadminuser.service.*.*(..))")
