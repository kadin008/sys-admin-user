package cn.net.aipic.sysadminuser.aspect;
...
import cn.net.aipic.sysadminuser.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* cn.net.aipic.sysadminuser.mapper.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* cn.net.aipic.sysadminuser.mapper.*.insert*(..))")
